...
function TopPerformers() {
  // این کامپوننت هیچ هوک، state، یا درخواست به API ندارد. فقط JSX ثابت است.
  return (
    <div style={{
      ...
      <h1>!!! تست نهایی برای آپدیت شدن فایل !!!</h1>
      <p>
        تاریخ و ساعت تست: {new Date().toLocaleString('fa-IR')}
      </p>
      <p>
        اگر این صفحه با پس‌زمینه مشکی، کادر قرمز و متن سبز را می‌بینی،
        یعنی فایل شما با موفقیت در Vercel آپدیت شده است.
      </p>
      <p style={{ color: 'yellow', marginTop: '20px', fontWeight: 'bold' }}>
        در این حالت، به هیچ وجه نباید خطای .map در کنسول وجود داشته باشد.
      </p>
    </div>
  );
}
